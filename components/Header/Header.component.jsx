...
const Header = props => {
    return <header className={styles.headerContainer}>
        ...
        <a href="https://www.producthunt.com/posts/relaxfrens?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-relaxfrens" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=332572&theme=light" alt="RelaxFrens - Create your own calm environment using relaxing sounds | Product Hunt" style={{ width: "250px", height: "54px" }} width="250" height="54" /></a>
    </header>
}
