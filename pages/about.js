  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Create your own environment using soothing and relaxing nature sounds to be more productive at work, study to ace your exams, practice yoga / meditation or just relax frens"
        />
      ...
      <main className={styles.main}>
        <Navbar />
        <h2>Hey there fren,</h2>
        <h3 className="text-center">
          I hope this app is helping you to focus more or to just relax.
          <br />
          Make sure you download it or bookmark for easy access :)
        </h3>
        <br />
        <br />
        <h2>Follow relaxfrens</h2>
        <a
          href="https://instagram.com/relaxfrens"
          target="_blank"
          rel="noreferrer"
          className="social-link m-10"
        >
          <BsInstagram />
        </a>
        <br />
        ...
        <div className="mt-10">
          ...
          <a
            href="https://instagram.com/zubairself"
            target="_blank"
            rel="noreferrer"
            className="social-link ml-10"
          >
            <BsInstagram />
          </a>
        </div>
        ...
        <h3>
          <a
            href="https://www.buymeacoffee.com/zubairself"
            target="_blank"
            rel="noreferrer"
            className="link1"
          >
